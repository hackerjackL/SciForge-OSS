...
All SciForge output files are organized by workflow stage:

```
project/
├── AGENT_DOC.md                              # Dashboard (root — read by all stages)
...
- **Dashboard**: `AGENT_DOC.md` — single source of truth, always latest
